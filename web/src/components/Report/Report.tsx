...
const Report = () =>{
    ...
    return (
        <div id="report">
            ...
            <ReportForm operation={handleAddressName} placeholder="What's the address Name?" formHeight={50}/>
            ...
            <div>
                ...
                <ReportForm operation={handleDetailContract} placeholder="Share more detail with the community" formHeight={130}/>
